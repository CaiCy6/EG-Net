...
if __name__ == '__main__':
    ...
    from models.OursAblation_4 import ConvNeXtEGNet as model
    ...
    parser.add_argument('--pth_path', type=str, default='/root/autodl-tmp/model_out/ISIC2016/ablation_baseline/ablation_baseline-last.pth')
    ...
    testset = 'ISIC2016_' + method_name      
    for _data_name in ['test']:
        data_path = '/root/autodl-tmp/datasets/ISIC2016/test/'

        save_path = './model_out/ISIC2016/' + method_name + '/ISIC2016_{}/'.format(_data_name)
